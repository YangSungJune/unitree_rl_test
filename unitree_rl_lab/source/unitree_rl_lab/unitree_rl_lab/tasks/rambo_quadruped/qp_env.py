...
from unitree_rl_lab.utils.helper import to_torch
...
@configclass
class QPEnvCfg(ManagerBasedRLEnvCfg):
    # simulation
...
class QPEnv(ManagerBasedRLEnv):
    ...
    def step(self, action: torch.Tensor):
        ...
        projected_gravity_b = math_utils.quat_apply_inverse(self._robot.data.root_quat_w, gravity_vec_w)
    ...
    def coms_pos_w(self):
        ...
        com_offset_w = math_utils.quat_apply(self.coms_quat.view(-1, 4), com_offset_b.view(-1, 3)).view(self.num_envs,
                                                                                                         -1, 3)
